    ...
    <section id="obzor" class="obzor sectio" data-hash="obzors">
        <div class="container">
            ...
            <div class="row bot-row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <p><span class="docSmart">Doctor Smart</span> предоставляет услуги широкого спектра, в котором одним из блоков являются телемедицинские услуги. Мировой рынок традиционных амбулаторных услуг может составить более $3,2* трлн к 2021 году.</p>
                    <p>До 60% амбулаторных приемов могут быть оказаны удаленно и впоследствии заменены онлайн-услугами. А это значит, что потенциал глобального рынка телемедицинских услуг в сопоставимом периоде достигнет $1,92 трлн.</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p>Мы не просто обеспечим любому оперативную онлайн-консультацию в области здоровья, мы
                            открываем<br> доступ к международному опыту авторитетных специалистов и публично подтверждаем качество
                        ...
                        <div class="box">
                            ...
                            <div class="desc">
                                <h5>Владимир Н. Никольский<br>
                                    <span>Основатель Doctor Smart.</span></h5>
                                <span class="right_doc">Операционный директор Mail.Ru Group с 2013 года. Присоединился к Mail.Ru Group как вице президент Направления онлайн-игр в 2009 году. До этого был Генеральным директором холдинга онлайн игр - Astrum Online Entertainment (2007-2009) и Со-основателем и Генеральным директором компании IT Territory занимавшейся онлайн играми (2004-2007).
                    </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="box box2">
                        ...
                        <div class="desc">
                            ...
                            <span>Руководитель проектов мобильного департамента в HeadHunter, в прошлом РП в игровой индустрии с опытом руководства разработкой более 8 лет. Работал над проектом с аудиторией более 75 миллионов пользователей. Сертифицированный agile professional (KMP-1, ICP, ICP-ATF).</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-5  col-md-5 col-sm-6 flex-row">
                    <div class="left-box">
                        ...
                        <p>Давайте объединим наши усилия для<br> формирования нового рынка  мировых стандартов<br> предоставления цифровых услуг в области поддержания здоровья!</p>
                    </div>
                </div>
